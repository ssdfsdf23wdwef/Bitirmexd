...
export const CourseCard: React.FC<CourseCardProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className={`h-1.5 bg-gradient-to-r w-full absolute top-0 left-0 rounded-t-xl transition-all duration-500 relative overflow-hidden ${
        isDarkMode 
      ...
      <div className="flex items-center mb-4 pt-1">
        ...
        <div className={`w-11 h-11 rounded-xl flex items-center justify-center border shadow-sm transition-all duration-300 relative overflow-hidden mr-3 group-hover:shadow-lg group-hover:scale-105 ${
          isDarkMode 
          ...
          <FiBook className={`text-lg transition-all duration-300 group-hover:scale-110 ${
        ...
        <div className="flex-1 min-w-0">
          <h3 className={`text-sm font-semibold transition-all duration-300 line-clamp-2 leading-snug ${
            isDarkMode 
        ...
        <button
          ...
          disabled={isDeleting}
        >
          <FiTrash2 className={`text-xs transition-transform duration-200 ${isDeleting ? 'animate-pulse' : 'hover:scale-110'}`} />
        </button>
      </div>
      
      {/* Compact last updated info */}
      <div className={`flex items-center text-xs ${isDarkMode ? 'text-gray-400 bg-blue-900/20 border-blue-800/30 group-hover:border-blue-700/40' : 'text-gray-500 bg-blue-50/60 border-blue-100/60 group-hover:border-blue-200/80'} mb-3 px-2.5 py-1.5 rounded-lg border transition-colors duration-300`}>
        <FiClock className={`mr-1.5 text-xs ${isDarkMode ? 'text-blue-400/80' : 'text-blue-500/80'} transition-colors duration-300`} />
