...
const QuizAnalysis: React.FC<QuizAnalysisProps> = memo(
  ({ quiz, showDetailedAnalysis = true }) => {
          ...
          <>
            ...
            <div className="bg-primary rounded-lg shadow-md border border-primary p-6">
              ...
              <div className="mt-6 text-sm text-secondary">
                <p className="mb-2">
                  <strong>Hesaplama Formülü:</strong> Toplam başarı oranı, her
                  alt konunun soru sayısına ve başarı oranına göre
                  ağırlıklandırılmış olarak hesaplanır.
                </p>
                <p className="mb-1">
                ...
                {weakTopics.length > 0 ? (
                  <ul className="space-y-2">
                    {weakTopics.map((topic) => (
                      <li
                        key={topic}
                        className="flex items-center text-state-error"
                      >
