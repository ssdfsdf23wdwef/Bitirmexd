...
const CourseTopicSelector: React.FC<CourseTopicSelectorProps> = ({
  ...
  return (
    <div
      className={`mb-8 rounded-3xl p-8 relative overflow-hidden backdrop-blur-xl border transition-all duration-500 ${isDarkMode ? "bg-gradient-to-br from-slate-800/80 via-slate-700/70 to-slate-800/80 border-slate-600/30 shadow-2xl shadow-slate-950/40" : "bg-gradient-to-br from-white/90 via-blue-50/80 to-white/90 border-gray-200/40 shadow-2xl shadow-gray-900/10"}`}
    >
      ...
      <div
        className={`absolute inset-0 opacity-30 ${isDarkMode ? "bg-gradient-to-br from-blue-500/10 via-purple-500/5 to-indigo-500/10" : "bg-gradient-to-br from-blue-300/10 via-purple-300/5 to-indigo-300/10"}`}
      />
      ...
      >
        ...
        >
          <FiTarget
            className={`${isDarkMode ? "text-blue-300" : "text-blue-600"} text-xl`}
          />
        </motion.span>
        <span
          className={`bg-gradient-to-r ${isDarkMode ? "from-blue-300 to-indigo-300" : "from-blue-600 to-indigo-600"} bg-clip-text text-transparent`}
        >
          İçerik Seçimi
        </span>
      </motion.h3>
      ...
      <div className="mb-6">
        <label
          className={`block text-sm font-medium mb-2 ${isDarkMode ? "text-blue-300" : "text-blue-600"}`}
        >
          Ders Seçimi
        </label>
        <div className="relative">
          <select
            ...
            className={`w-full px-4 py-3 pr-10 border rounded-lg appearance-none transition-all duration-300 cursor-pointer shadow-sm backdrop-blur-md ${
              isDarkMode
                ? "bg-gray-800/50 border-gray-700/60 text-gray-200 focus:border-blue-500/80 hover:border-blue-600/70 focus:ring-blue-500/30"
                : "bg-white/60 border-gray-300/80 text-gray-800 focus:border-blue-500/70 hover:border-blue-400/90 focus:ring-blue-500/30"
          ...
          <div
            className={`absolute right-3.5 top-1/2 transform -translate-y-1/2 pointer-events-none ${isDarkMode ? "text-blue-400/80" : "text-blue-500/90"}`}
          >
            <svg
        ...
        <p className="text-xs mt-2 italic text-gray-500 dark:text-gray-400">
          Sınavın ilgili olduğu dersi seçin
        </p>
      </div>
      ...
      {quizType === "personalized" &&
        personalizedQuizType === "learningObjectiveFocused" && (
          <div
            className={`mb-6 p-4 rounded-xl relative overflow-hidden backdrop-blur-md border ${isDarkMode ? "bg-blue-900/30 border-blue-700/40 shadow-lg shadow-blue-950/20" : "bg-blue-50/70 border-blue-200/60 shadow-lg shadow-blue-200/30"}`}
          >
            {/* Gradient accent */}
            <div
              className={`absolute left-0 top-0 bottom-0 w-1.5 bg-gradient-to-b ${isDarkMode ? "from-blue-600 to-indigo-600" : "from-blue-500 to-indigo-500"} opacity-90 rounded-l-xl`}
            ></div>

            <div className="flex items-center gap-2.5 mb-2 pl-4">
              <div
                className={`p-2 rounded-lg shadow-sm ${isDarkMode ? "bg-blue-800/50" : "bg-blue-100/90"}`}
              >
                <FiTarget
              ...
              <h4
                className={`font-semibold ${isDarkMode ? "text-blue-300" : "text-blue-700"}`}
              >
                Öğrenme Hedefi Odaklı Sınav
              </h4>
            </div>
            <p
              className={`text-sm ${isDarkMode ? "text-gray-300" : "text-gray-700"} ml-11 pl-0.5`}
            >
              Yapay zeka, seçtiğiniz konuların öğrenme hedeflerine uygun sorular
              oluşturacak ve ilerlemenizi ölçecektir.
            </p>
          </div>
        )}
      ...
      <div className="mb-6">
        <label
          className={`block text-base font-semibold mb-3 flex items-center ${isDarkMode ? "text-blue-300" : "text-blue-600"}`}
        >
          <span
            className={`w-7 h-7 rounded-lg flex items-center justify-center mr-2.5 shadow-md ${isDarkMode ? "bg-gradient-to-br from-blue-700/40 to-indigo-700/50" : "bg-gradient-to-br from-blue-100 to-indigo-100"}`}
          >
        ...
        <div className="flex flex-wrap gap-2 mb-2">
          {courseTopics.length === 0 ? (
            <div
              className={`w-full p-4 rounded-xl border text-sm flex items-center justify-center backdrop-blur-md ${isDarkMode ? "bg-gray-800/50 border-gray-700/60 text-gray-400 shadow-md shadow-gray-950/10" : "bg-gray-50/80 border-gray-200/70 text-gray-500 shadow-md shadow-gray-200/20"}`}
            >
              <div
                className={`p-1.5 rounded-lg ${isDarkMode ? "bg-gray-700/50" : "bg-gray-100/90"} mr-2.5 shadow-sm`}
              >
                <FiTarget
            ...
            courseTopics.map((topic) => {
              ...
              return (
                ...
                >
                  ...
                  <div
                    className={`absolute inset-0 rounded-xl transition-all duration-300 group-hover:opacity-100 ${
                      selectedTopicIds.includes(topic.id)
                        ...
                        : `${isDarkMode ? "bg-gray-800/40" : "bg-white/60"} opacity-0`
                    }`}
                  ></div>
                  ...
                  {StatusIcon && (
                    <div
                      className={`relative z-10 p-1.5 rounded-lg transition-all duration-300 ${selectedTopicIds.includes(topic.id) ? (isDarkMode ? "bg-white/25" : "bg-white/30") : isDarkMode ? "bg-gray-700/70 group-hover:bg-gray-600/50" : "bg-gray-100/90 group-hover:bg-gray-200/70"} shadow-sm`}
                    >
                      <StatusIcon
                        className={`w-3.5 h-3.5 ${selectedTopicIds.includes(topic.id) ? "text-white" : statusColor}`}
                      />
                    </div>
                  )}
                  <span
        ...
        <p className="text-xs text-gray-500 dark:text-gray-400 italic mt-2">
          Sınavda yer almasını istediğiniz konuları seçin
        </p>
      </div>
      ...
      {topicSubTopics.length > 0 && (
        <div className="mb-6">
          <label
            className={`block text-sm font-medium mb-3 flex items-center ${isDarkMode ? "text-blue-300" : "text-blue-600"}`}
          >
          ...
          <div
            className={`flex flex-wrap gap-1.5 p-3 rounded-2xl border backdrop-blur-lg ${isDarkMode ? "bg-gray-800/50 border-gray-700/60 shadow-xl shadow-gray-950/20" : "bg-white/70 border-gray-200/60 shadow-xl shadow-gray-300/30"}`}
          >
            {topicSubTopics.map((subTopic) => {
              ...
              return (
                ...
                >
                  {/* Background and styling */}
                  <div
                    className={`absolute inset-0 rounded-lg transition-all duration-300 group-hover:opacity-100 ${
                  ...
                  {StatusIcon && (
                    <div
                      className={`relative z-10 p-1 rounded-md transition-all duration-300 ${selectedSubTopicIds.includes(subTopic.id) ? (isDarkMode ? "bg-white/25" : "bg-white/30") : isDarkMode ? "bg-gray-700/70 group-hover:bg-gray-600/50" : "bg-gray-100/90 group-hover:bg-gray-200/70"} shadow-sm`}
                    >
                      <StatusIcon
                        className={`w-3 h-3 ${selectedSubTopicIds.includes(subTopic.id) ? "text-white" : statusColor}`}
                      />
                    </div>
                  )}
                  <span
                    className={`relative z-10 font-medium transition-all duration-300 max-w-[120px] truncate ${
                      selectedSubTopicIds.includes(subTopic.id)
                        ? "text-white"
                        : isDarkMode
                          ? "text-gray-300"
          ...
          <p className="text-xs text-gray-500 dark:text-gray-400 italic mt-2">
            Daha spesifik alt konular seçerek sınavınızı özelleştirebilirsiniz
          </p>
        </div>
      )}
    </div>
