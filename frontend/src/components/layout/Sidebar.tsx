    ...
    >
      ...
      >
        ...
        >
          <FiChevronLeft
            size={16}
            className="stroke-[2px] group-hover:stroke-[2.5px] transition-all duration-300"
          />
        </motion.div>
      ...
      <div
        className={`h-16 px-4 border-b backdrop-blur-xl flex items-center relative ${
          isDarkMode
        ...
        >
          {!isCollapsed && (
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2
                  className={`text-lg font-bold tracking-wide bg-gradient-to-r ${
                    isDarkMode
                ...
                <p
                  className={`text-xs ${isDarkMode ? "text-slate-400" : "text-gray-500"} -mt-1`}
                >
                ...
                {menuItems.map((item, index) => (
                  ...
                  >
                    ...
                    >
                      ...
                      {isActive(item.href) && (
                        <div
                          className={`absolute inset-0 rounded-2xl bg-gradient-to-r ${item.gradient} opacity-5 blur-md`}
                        />
                      )}
                      ...
                      {!isActive(item.href) && (
                        ...
                        >
                          <div
                            className={`w-1.5 h-1.5 rounded-full ${isDarkMode ? "bg-slate-400" : "bg-gray-400"} opacity-60`}
                          />
                        </motion.div>
                      )}
                    </FastLink>
                ...
                >
                  ...
                  >
                    ...
                    <motion.div
                      ...
                      whileHover={{
                        scale: isActive("/settings") ? 1.05 : 1.1,
                        rotate: 90,
                      }}
                      whileTap={{ scale: 0.95 }}
                      transition={{
      ...
      <div
        className={`h-2 w-full ${isDarkMode ? "bg-gradient-to-r from-gray-900 via-blue-900/20 to-gray-900" : "bg-gradient-to-r from-white via-blue-100/20 to-white"}`}
      ></div>
    </motion.div>
  );
}
