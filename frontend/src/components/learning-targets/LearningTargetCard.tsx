...
const LearningTargetCard: React.FC<LearningTargetCardProps> = memo(
  ({ target }) => {
    ...
    const handleStatusChange = useCallback(
      async (newStatus: LearningTargetStatus) => {
          ...
          sx={{
            ...
            borderLeft: `4px solid ${
              target.status === LearningTargetStatus.NOT_STARTED
                ? "grey.400"
                : target.status === LearningTargetStatus.IN_PROGRESS
                  ? "primary.main"
                  : "success.main"
            }`,
          }}
          ...
          <DialogContent>
            <Box mt={2}>
              ...
              <TextField
                ...
                onChange={(e) =>
                  setEditedTarget({ ...editedTarget, notes: e.target.value })
                }
                margin="dense"
              />
            </Box>
