    ...
    <ProtectedRoute>
      <div className={`min-h-screen relative ${isDarkMode ? 'bg-gradient-to-br from-gray-900 via-blue-900/10 to-gray-900' : 'bg-gradient-to-br from-blue-50/30 via-white to-indigo-50/40'} transition-colors duration-500`}>
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className={`absolute bottom-1/4 right-1/4 w-64 h-64 ${isDarkMode ? 'bg-purple-600/5' : 'bg-purple-400/8'} rounded-full blur-3xl animate-pulse-slow transition-colors duration-500`} style={{ animationDelay: '2s' }}></div>
