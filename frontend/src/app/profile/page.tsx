...
export default function ProfilePage() {
  ...
  useEffect(() => {
    ...
    const initializeProfile = async () => {
      ...
      try {
        ...
        if (isMounted) {
          setError(
            "Sayfa başlatılırken bir hata oluştu. Lütfen sayfayı yenileyin.",
          );
          setIsLoading(false);
        }
      }
    ...
    try {
      ...
      if (tempProfileImage) {
        try {
          ...
          console.error("Profil resmi yükleme hatası:", error);
          showToast(
            "Profil resmi yüklenemedi, ancak diğer bilgileriniz güncellenecek",
            "warning",
          );
  ...
  if (error) {
    return (
      <div className="flex flex-col justify-center items-center h-screen">
        <div
          className={`p-4 rounded-lg ${isDark ? "bg-red-900" : "bg-red-100"} mb-4`}
        >
        ...
        <div className="lg:col-span-1">
          ...
          >
            <div className="flex flex-col items-center">
              ...
              <h2
                className={`text-xl font-semibold mt-4 ${isDark ? "text-gray-100" : "text-gray-800"}`}
              >
                {getDisplayName()}
              </h2>
              <p className={isDark ? "text-gray-300" : "text-gray-600"}>
            ...
            <div className="mt-8">
              <h3
                className={`text-lg font-medium ${isDark ? "text-gray-100" : "text-gray-800"} mb-4`}
              >
                Hesap Bilgileri
              </h3>
        ...
        <div className="lg:col-span-2">
          ...
          >
            <div className="flex justify-between items-center mb-6">
              <h3
                className={`text-lg font-medium ${isDark ? "text-gray-100" : "text-gray-800"}`}
              >
                Profil Detayları
              </h3>
            ...
            <div className="mt-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <div
                  className={`${isDark ? "bg-indigo-900" : "bg-indigo-50"} p-4 rounded-lg`}
                >
                  <h4
                    className={`text-sm font-medium ${isDark ? "text-indigo-300" : "text-indigo-800"} mb-2`}
                  >
                    Toplam Sınav
                  </h4>
                  <p
                    className={`text-2xl font-bold ${isDark ? "text-indigo-200" : "text-indigo-700"}`}
                  >
                    0
                  </p>
                </div>
                ...
                <div
                  className={`${isDark ? "bg-green-900" : "bg-green-50"} p-4 rounded-lg`}
                >
                  <h4
                    className={`text-sm font-medium ${isDark ? "text-green-300" : "text-green-800"} mb-2`}
                  >
                    Uzmanlaşılan Konular
                  </h4>
                  <p
                    className={`text-2xl font-bold ${isDark ? "text-green-200" : "text-green-700"}`}
                  >
                    0
                  </p>
                </div>
                ...
                <div
                  className={`${isDark ? "bg-amber-900" : "bg-amber-50"} p-4 rounded-lg`}
                >
                  <h4
                    className={`text-sm font-medium ${isDark ? "text-amber-300" : "text-amber-800"} mb-2`}
                  >
                    Geliştirilmesi Gereken
                  </h4>
                  <p
                    className={`text-2xl font-bold ${isDark ? "text-amber-200" : "text-amber-700"}`}
                  >
                    0
                  </p>
                </div>
