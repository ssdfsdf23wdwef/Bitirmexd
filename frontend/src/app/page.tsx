...
export default function Home() {
  ...
  const handleStartPersonalizedQuiz = () => {
    if (!isAuthenticated && !isAuthInitializing) {
      router.push(
        `/auth/login?returnUrl=${encodeURIComponent("/?wizard=personalized")}`,
        { scroll: false },
      );
      return;
    }
  ...
  const handleExamCreationComplete = (result: {
    ...
    try {
      ...
      console.log(
        "Ana sayfada ExamCreationWizard tamamlandı, doğrudan quiz oluşturma API çağrısı yapılacak",
      );

      if (result.quizId) {
        console.log(
          `Quiz ID mevcut (${result.quizId}), doğrudan sınav sayfasına yönlendiriliyor`,
        );
  ...
  return (
    <PageTransition>
      <div
        className={`w-full min-h-[calc(100vh-64px)] flex flex-col items-center justify-center px-2 py-8 md:py-16 relative overflow-hidden transition-all duration-500 ${
          isDarkMode
            ? "bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950"
            : "bg-gradient-to-br from-blue-50 via-white to-purple-50"
        }`}
      >
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          {/* Central glow effect */}
          <div
            className={`absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] rounded-full opacity-10 blur-[120px] transition-all duration-500 ${
              isDarkMode
              ...
              >
                ...
                <div
                  className={`absolute inset-0 transition-all duration-500 ${
                    isDarkMode
                      ? "bg-gradient-to-br from-slate-800/20 to-slate-900/40"
                      : "bg-gradient-to-br from-white/40 to-blue-50/60"
                  }`}
                />
                ...
                />
                <div
                  className={`absolute bottom-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-purple-400/60 to-transparent ${
                    isDarkMode ? "opacity-80" : "opacity-50"
                  }`}
                />
                ...
                <div
                  className={`absolute top-0 left-0 right-0 h-32 transition-all duration-500 ${
                    isDarkMode
                      ? "bg-gradient-to-b from-blue-400/10 via-purple-400/5 to-transparent"
                      : "bg-gradient-to-b from-blue-300/20 via-purple-300/10 to-transparent"
                  }`}
                />
                ...
                <div className="relative py-12 md:py-16 px-4 md:px-8">
                  <div className="max-w-4xl mx-auto">
                    <div className="text-center">
                      ...
                      >
                        <span
                          className={`px-4 py-2 rounded-full backdrop-blur-xl text-xs font-medium border shadow-lg inline-flex items-center gap-2 transition-all duration-500 ${
                            isDarkMode
                      ...
                      >
                        Bilgi seviyenizi ölçün, eksiklerinizi tespit edin ve
                        öğrenme sürecinizi
                        <span
                          className={`font-semibold ${isDarkMode ? "text-blue-300" : "text-blue-600"}`}
                        >
                          {" "}
                      ...
                      >
                        ...
                        >
                          ...
                          <div
                            className={`absolute inset-0 bg-gradient-to-br opacity-20 transition-all duration-700 ${
                              isDarkMode
                                ? "from-blue-500/30 via-indigo-500/20 to-transparent"
                                : "from-blue-400/20 via-indigo-400/15 to-transparent"
                            }`}
                          />
                          <motion.div
                            animate={{
                          ...
                          <div className="relative z-10">
                            <div className="flex justify-between items-start mb-6">
                              ...
                              <span
                                className={`text-xs px-3 py-1.5 rounded-full border shadow-sm backdrop-blur-md font-medium transition-all duration-300 ${
                                  isDarkMode
                            ...
                            <p
                              className={`mb-8 text-sm leading-relaxed transition-all duration-300 ${
                                isDarkMode ? "text-slate-300" : "text-gray-600"
                              }`}
                            >
                              Üyelik gerektirmeden istediğiniz konuda bilgi
                              seviyenizi hemen test edin. Seçtiğiniz alanda
                              temel bilgilerinizi ölçmek için ideal.
                            </p>
                        ...
                        >
                          ...
                          <div
                            className={`absolute inset-0 bg-gradient-to-br opacity-20 transition-all duration-700 ${
                              isDarkMode
                                ...
                                : "from-purple-400/20 via-pink-400/15 to-transparent"
                            }`}
                          />
                          <motion.div
                            animate={{
                          ...
                          <div className="relative z-10">
                            ...
                            >
                              Öğrenme geçmişiniz, performansınız ve
                              hedeflerinize göre tamamen size özel sınavlar
                              oluşturun ve ilerlemenizi takip edin.
                            </p>
